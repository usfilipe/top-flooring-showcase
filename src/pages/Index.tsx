  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://github.com/usfilipe/top-flooring-showcase/blob/main/src/photos/F3/IMG-20250616-WA0078.jpg')`
        }}
      >
